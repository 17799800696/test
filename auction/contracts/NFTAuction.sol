...
contract NFTAuction is ReentrancyGuard, Ownable, Initializable {
    ...
    mapping(address => uint256[]) public userAuctions; // 用户创建的拍卖
    mapping(address => uint256[]) public userBids;     // 用户参与的拍卖
    uint256 public auctionCounter;
    uint256 public platformFeeRate = 250; // 2.5% (基数10000)
    ...
    function _getETHPriceInUSD(uint256 ethAmount) internal view returns (uint256) {
        ...
        // price是8位精度，ethAmount是18位精度，返回18位精度的USD
